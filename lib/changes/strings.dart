...
String servicesSubHeading =
    "Since the beginning of my journey as a developer, I’ve worked with startups and collaborated with talented teams to build digital products for both business and consumer use. I offer a wide range of services, including brand strategy, programming, and mentoring.";
//
...
const String aboutMeHeadline =
    'I\'m Hammad Ramzan, a Mobile App developer, Web developer and UI designer.';
