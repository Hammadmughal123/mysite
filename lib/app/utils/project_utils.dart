...
List<ProjectUtils> projectUtils = [
  ProjectUtils(
    ...
    links: 'https://github.com/Hammadnb/poetically-.git',
  ),
  ProjectUtils(
    ...
    links: 'https://github.com/Hammadnb/',
  ),
  ProjectUtils(
    ...
    links: 'https://github.com/Hammadnb/elderly_exercise_app.git',
  ),
  ProjectUtils(
    ...
    links: 'https://github.com/Hammadnb/flutter_plant_app.git',
  ),
];
